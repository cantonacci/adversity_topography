...
TAB = cfg.BASE_DIR / 'outputs' / 'tables'
WP  = cfg.BASE_DIR / 'code/05_behavior/within_person/derived/results_within_person_cbcl.txt'
OUT = cfg.BASE_DIR / 'manuscript' / 'Supplement_full_draft.docx'
...
def main():
    ...
    rowsS7 = []
    _Nobs = _Nsub = None
    for _src, _lbl in cfg.CBCL_MEDIATION_OUTCOMES.items():
    ...
    _figp = cfg.BASE_DIR / 'outputs/figures/supplement/figS1_ela_correlation.png'
    if _figp.exists():
